<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{route('bannerimage.index')}}">Banner Image</a></li>
            ...
            <li class="nav-item"> <a class="nav-link" href="{{route('client.index')}}">Client</a></li>
            <li class="nav-item"> <a class="nav-link" href="{{route('footer.index')}}">Footer</a></li>
          </ul>
        </div>
      </li>
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{route('show.order')}}">
          <span class="menu-icon">
